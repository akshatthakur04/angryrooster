// Hoodie Product Page JavaScript
...
function initializeHeroGallery() {
    ...
    const images = [
        { src: '../product page.png', alt: 'PowerKnit™ Training Hoodie Back' },
        { src: '../Front.png', alt: 'PowerKnit™ Training Hoodie Front' }
    ];
...
function initializeWishlist() {
    ...
    if (wishlistBtn) {
        ...
        const isInWishlist = localStorage.getItem('hoodie_in_wishlist') === 'true';
        if (isInWishlist) {
        ...
        wishlistBtn.addEventListener('click', function() {
            ...
            if (isActive) {
                ...
                localStorage.setItem('hoodie_in_wishlist', 'false');
                showNotification('Removed from wishlist', 'info');
            } else {
                // Add to wishlist
                this.classList.add('active');
                localStorage.setItem('hoodie_in_wishlist', 'true');
...
function highlightSizeSection() {
    ...
    if (sizeSection) {
        sizeSection.style.background = 'rgba(239, 68, 68, 0.05)';
        sizeSection.style.borderRadius = '12px';
        sizeSection.style.padding = '32px 20px';
        sizeSection.style.border = '2px solid rgba(239, 68, 68, 0.2)';
